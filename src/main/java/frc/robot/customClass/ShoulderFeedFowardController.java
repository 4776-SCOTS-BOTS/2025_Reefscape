...
public class ShoulderFeedFowardController {
   ...
   */
  public ShoulderFeedFowardController(double ks, double kgAlpha, double kv, double ka) {
    this.ks = ks;
   ...
   * @param kv The velocity gain.
   */
  public ShoulderFeedFowardController(double ks, double kgAlpha, double kv) {
    this(ks, kgAlpha, kv, 0);
  }
